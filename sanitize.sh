...
jupyter nbconvert --clear-output --to notebook --output=/share/git-repo/Scripts/automation-tools/initial-scans.ipynb /share/git-repo/Notebooks/initial\ scans.ipynb >/dev/null
jupyter nbconvert --clear-output --to notebook --output=/share/git-repo/Scripts/automation-tools/libvirt-provision.ipynb /share/git-repo/Notebooks/libvirt-provision.ipynb >/dev/null
