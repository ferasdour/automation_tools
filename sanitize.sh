...
cp /share/pentests/ansible-pentest/buildContainerFromVM.yml /share/public-git-repos/automation-tools/buildContainerFromVM.yml
cp /share/pentests/ansible-pentest/k3d-provision.yml /share/public-git-repos/automation-tools/k3d-provision.yml
